...
export default function DecisionTreeClassifierForm() {
    ...
    const handleSave = useCallback(
        async (e?: React.FormEvent) => {
            e?.preventDefault?.();
            dispatch(updateDecisionTreeClassifierConfig(state));
            alert("Configuration Saved. Ready to Train.");
        },
        [dispatch, state]
    );
        ...
        <form onSubmit={handleSave} className="space-y-6">
            <div className={sectionClasses}>
                <div>
                    ...
                    <input
                        placeholder="e.g. Churn Classifier"
                        value={modelName}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={inputClasses}
                                >
                                    <option value="best">best (greedy)</option>
